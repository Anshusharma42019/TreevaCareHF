  ...
  return (
    <div className="relative z-[100] w-full max-w-2xl" ref={containerRef}>
      ...
      <div className="relative">
        ...
        <input
          type="text"
          className="block w-full pl-11 pr-10 py-2.5 bg-white/75 backdrop-blur-md border border-white/80 rounded-full text-sm placeholder:text-gray-500 text-gray-900 focus:outline-none focus:ring-2 focus:ring-emerald-500/30 focus:bg-white/95 transition-all shadow-sm"
