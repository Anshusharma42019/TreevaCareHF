            ...
            <div style={{ display: 'flex', border: '1px solid #000', borderTop: 'none' }}>
              ...
              <div style={{ flex: 1, padding: '14px 16px' }}>
                ...
                <div style={{ fontSize: 11.5, color: '#333', marginTop: 4, lineHeight: 1.5 }}>
                  ...
                  {(shipment.problem || shipment.lead_id?.problem) && (
                    <div style={{ marginTop: 4, fontSize: 11, color: '#c2410c', fontWeight: 700 }}>
                      Problem: {shipment.problem || shipment.lead_id?.problem}
                    </div>
                  )}
                </div>
              </div>
                    ...
                    <tr key={li.sno}>
                      ...
                      <td style={{ ...cellBase, fontWeight: 600 }}>
                        {li.isDoctor ? (
                          ...
                          <>
                            <span className="invoice-print-only">
                              {li.description}
                              {(shipment.problem || shipment.lead_id?.problem) && (
                                <div style={{ fontSize: 10, color: '#555', fontStyle: 'italic', marginTop: 2, fontWeight: 500 }}>
                                  Problem: {shipment.problem || shipment.lead_id?.problem}
                                </div>
                              )}
                            </span>
                            ...
                            />
                            {(shipment.problem || shipment.lead_id?.problem) && (
                              <div className="invoice-no-print" style={{ fontSize: 10, color: '#c2410c', fontWeight: 600, marginTop: 2 }}>
                                Problem: {shipment.problem || shipment.lead_id?.problem}
                              </div>
                            )}
                          </>
