    ...
    <Routes>
      ...
      <Route path="/" element={<ProtectedRoute><Layout /></ProtectedRoute>}>
        ...
        <Route path="doctor-dashboard" element={
          <ProtectedRoute roles={['admin', 'manager', 'doctor']}><DoctorDashboard /></ProtectedRoute>
        } />
        ...
        <Route path="account/delivered" element={
          <ProtectedRoute roles={['admin', 'manager']}><Account /></ProtectedRoute>
        } />
        ...
        <Route path="ops-dashboard" element={
          <ProtectedRoute roles={['admin', 'manager', 'sales', 'support', 'logistics', 'staff']}><OpsDashboard /></ProtectedRoute>
        } />
