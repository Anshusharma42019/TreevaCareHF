...
const DetailRow = ({ label, value, color = "gray" }) => {
  ...
  return (
    <div className="flex items-start gap-3 py-2 border-b border-gray-50 last:border-0">
      ...
      <span className={`text-sm font-medium flex-1 whitespace-pre-wrap leading-relaxed ${isMultiLine ? '' : 'capitalize'} ${color === 'red' ? 'text-red-600' : value ? 'text-gray-800' : 'text-gray-400'}`}>
        {value || 'Not provided'}
      </span>
    </div>
  );
