  ...
  return (
    <div
      ...
      style={{
        ...
        boxShadow: `0 4px 16px -2px rgba(15, 23, 42, 0.06), 0 2px 6px -1px ${colorHex}20`,
        minHeight: 120,
        height: '100%',
      }}
      onMouseEnter={e => { 
        e.currentTarget.style.boxShadow = `0 10px 28px -4px ${colorHex}35`; 
        e.currentTarget.style.transform = 'translateY(-4px)'; 
        e.currentTarget.style.borderColor = `${colorHex}60`;
      }}
      onMouseLeave={e => { 
        e.currentTarget.style.boxShadow = `0 4px 16px -2px rgba(15, 23, 42, 0.06), 0 2px 6px -1px ${colorHex}20`; 
        e.currentTarget.style.transform = 'none'; 
        e.currentTarget.style.borderColor = `${colorHex}35`;
      }}
    >
